              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                <div className="p-4 flex-1 flex flex-col items-start justify-start gap-2">
                  <div className="flex items-center gap-4 justify-center bg-black-gradient px-3 py-0 rounded-full">
                    <p
                      className={`text-base ${styles.paragraph} text-[9px] md:text-[11px]`}
                    >
                  ...
                  <h2 className="text-[2.5rem] font-bold tracking-wide">
                    ...
                    <br />
                    <span className="text-[3.5rem] text-gradient">
                      {" "}
                      Now Available
                    </span>
                  </h2>
                  <p
                    className={`${styles.paragraph} mt-2 text-center text-[0.8rem] md:text-left`}
                  >
                    Island wide delivery on all orders. Colombo & selected
                    suburbs to be delivered on the following day, and island
                    wide fulfilment within 5 days (Working days only). Minimum
                    order value Rs.5000. The above does not apply to areas under
                    travel restrictions
                  </p>
                  <button
                    type="button"
