...
const Navbar = () => {
  ...
  return (
    <div
      className={`${styles.paddingX} ${styles.flexCenter} bg-primary w-full overflow-hidden`}
    >
          ...
          <ul className="list-none sm:flex hidden justify-end items-center flex-1">
            {navLinks.map((nav, index) => (
              ...
              >
                ...
                <li
                  className={`font-normal cursor-pointer text-[13px] text-white mr-10`}
                >
            ...
            <li>
              <img
                ...
                className="w-[25px] h-[25px] cursor-pointer rounded-full {`${styles.avatar}`}"
                whiletap={{ scale: 0.6 }}
              />
              {isMenu && (
                <motion.div
            ...
            >
              <ul className="list-none flex flex-col justify-end items-center flex-1">
                {navLinks.map((nav, index) => (
                  <li
                    key={nav.id}
                    className={`font-normal cursor-pointer text-[11px] text-white
                ...
                <li>
                  ...
                  <motion.img
                    ...
                    className="w-[25px] h-[25px] cursor-pointer rounded-full mt-3 mb-1"
                    whiletap={{ scale: 0.6 }}
                  />
                  {isMenu && (
                    <div
